...
$knesysGrey: ${theme.colors.knesysGrey}; 
...
$navbarBackground: $knesysBlue;
$navbarBorder: 1px solid $knesysGreen;

$navbarButtonBackground: lighten($knesysBlue, 3%);
$navbarButtonBackgroundHighlight: lighten($knesysBlue, 5%);

$navbar-button-border: $knesysGreen;

// Sidemenu
// -------------------------
$side-menu-bg: $knesysBlue;
$side-menu-bg-mobile: $knesysBlue; //$gray-6;
$side-menu-item-hover-bg: $knesysGrey;
$side-menu-shadow: 5px 0px 10px -5px $gray-1;
$side-menu-link-color: $white ;

// Menu dropdowns
// -------------------------
$menu-dropdown-bg: $knesysBlue;
$menu-dropdown-hover-bg: $knesysBlue;
$menu-dropdown-shadow: 5px 5px 10px -5px $knesysBlue;
